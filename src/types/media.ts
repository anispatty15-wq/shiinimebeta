...
export interface ComicCard extends MediaCard {}
export interface HentaiCard extends MediaCard {}
export interface AnimeCard extends MediaCard {}
export interface AnimeEpisode extends AnimeEpisodeData {}
...
export interface MaidComicCard extends MediaCard {
  genres?: string[];
  author?: string;
  artist?: string;
}

export interface MaidComicChapter {
  title: string;
  slug: string;
  number?: string;
  release_date?: string;
...
export interface MaidComicDetail {
  title: string;
  slug: string;
  cover: string;
  synopsis: string;
  ...
  status: string;
  genres: string[];
  chapters: MaidComicChapter[];
}

export interface MaidComicChapterData {
  title: string;
  images: string[];
  prev_chapter_slug: string;
  next_chapter_slug: string;
