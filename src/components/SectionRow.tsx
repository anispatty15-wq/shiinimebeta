...
export default function SectionRow({
  ...
  return (
    <section className={clsx('mb-10 animate-fade-up', className)}>
      {/* Header */}
      <div className="flex items-center justify-between mb-4 px-4">
        <h2 className="flex items-center gap-2.5 text-base font-semibold tracking-tight text-primary">
          <span
        ...
        {moreHref && (
          <Link
            href={moreHref}
            className="flex items-center gap-1 rounded-full border border-cyan/15 bg-cyan/[0.05] px-2.5 py-1 text-xs font-medium text-cyan transition-all hover:border-cyan/30 hover:bg-cyan/10"
          >
