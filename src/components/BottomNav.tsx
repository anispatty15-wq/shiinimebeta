  ...
  return (
    <nav
      ...
      className={clsx(
        ...
        'bg-surface/80 backdrop-blur-2xl border-t border-white/[0.08] shadow-[0_-10px_30px_rgba(0,0,0,0.2)]'
      )}
    >
        ...
        return (
          <Link
            ...
            className={clsx(
              ...
              'py-3 text-[0.62rem] font-semibold transition-all duration-200',
