    ...
    <div className="min-h-screen pb-20 md:pb-0">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="bg-surface border border-border rounded-app overflow-hidden mb-6">
          {/* Cover background selected in profile settings */}
          <div
            className="h-32 bg-gradient-to-br from-cyan/20 via-violet/20 to-pink/20"
            style={profile.bioBackground ? { background: profile.bioBackground } : undefined}
          />
